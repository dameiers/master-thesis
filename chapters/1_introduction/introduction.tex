...
The similar functionality of such web applications and Swing based renderer and editors in the Navigator offer the chance to use those web applications as a replacement for the Swing based editors.
