...
Hence the current implementation uses CalpaHTML as default case, there is only one boolean property called \enquoute{\texttt{useFlyingSaucer}} that indicates to use the \texttt{DescriptionPaneFS} class, a description pane that uses the FlyingSaucer API.
