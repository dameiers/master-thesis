...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushright}
	\includegraphics[width=\textwidth]{img/titlepages/logo_cismet_grey}
	\end{flushright}
\end{minipage}
~\\[1cm]
\includegraphics[width=0.6\textwidth]{img/titlepages/puzzleGrey}
~\\[1cm]

\begin{flushright}
\textsc{\Large Integration of Web UI Technologies \\in cids Navigator}
...
\begin{minipage}[t]{0.4\textwidth}
	\begin{flushleft}
	\includegraphics[width=\textwidth]{img/titlepages/logo_htw_saar}
	\end{flushleft}
\end{minipage}
\hfill
\begin{minipage}[t]{0.4\textwidth}
